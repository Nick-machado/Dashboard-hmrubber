...
SELECT 
  ...
  CAST((I.TOTMERC / NULLIF(I.QUANT, 0)) AS NUMERIC(15,4)) AS VALOR_UNIT, I.TOTMERC,
  ...
  -COALESCE((N.VALOR_FRETE_PAGO * (I.TOTMERC / NULLIF(N.TOTMERC, 0))), 0) AS VALOR_FRETE,
  -(COALESCE(F.VALOR, 0) * (I.TOTMERC / NULLIF(N.TOTMERC, 0))) AS VAL_OUTRAS,
