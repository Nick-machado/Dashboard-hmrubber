...
SELECT
  ...
  (I.TOTMERC + ABS(I.VALORIPI) - (I.ICMS_ZF + I.PIS_COFINS_ZF) + (COALESCE(I.NFE_VFRETE,0) + COALESCE(I.NFE_VDESPESAS,0) + COALESCE(I.NFE_VSEGURO,0))) AS "Total NF",
  I.TOTMERC AS "Total Merc.",
  (COALESCE(I.NFE_VFRETE,0) + COALESCE(I.NFE_VDESPESAS,0) + COALESCE(I.NFE_VSEGURO,0)) AS "Frete+Seg",
