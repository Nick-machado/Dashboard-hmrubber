...
WHERE N.EMPRESA = 1
  AND N.SITUACAO = 'N'
  -- AND N.DATA BETWEEN '2025-06-01' AND '2025-06-09' -- Filtro de data comentado
  -- AND I.ID_TIPONOTA IN (4,338,8,232,185,96,302,301,346,65,2,222,340,243,223,341,112,98,226,156,225,339,1,213,211,212,64,218,219,333,69,233,234,330,81) -- Filtro de tipo de nota comentado
